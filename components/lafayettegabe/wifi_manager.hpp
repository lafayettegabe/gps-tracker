...
public:
    ...
    void connect() {
        initialize_nvs();   // Initialize NVS (Non-Volatile Storage)
...
void WiFiManager::initialize_nvs() {
...
void WiFiManager::initialize_wifi() {
    ...
    ESP_LOGI(TAG_WIFI, "WiFi Init STA finished.");
    ...
    if (bits & WIFI_CONNECTED_BIT) {
        ...
        ESP_LOGI(TAG_WIFI, "Failed to connect to AP SSID: %s", WIFI_SSID);
    } else {
